...
<h1> <a id="user-content-path-to-regexp" class="anchor" href="#path-to-regexp" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>Path-to-RegExp</h1> 
...
<div class="highlight highlight-source-js">
 <pre><span class="pl-k">var</span> pathToRegexp <span class="pl-k">=</span> <span class="pl-c1">require</span>(<span class="pl-s"><span class="pl-pds">'</span>path-to-regexp<span class="pl-pds">'</span></span>);</pre>
</div> 
<h3> <a id="user-content-pathtoregexppath-keys-options" class="anchor" href="#pathtoregexppath-keys-options" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>pathToRegexp(path, keys, options)</h3> 
<ul> 
...
<div class="highlight highlight-source-js">
 <pre><span class="pl-k">var</span> keys <span class="pl-k">=</span> [];
<span class="pl-k">var</span> exp <span class="pl-k">=</span> <span class="pl-en">pathToRegexp</span>(<span class="pl-s"><span class="pl-pds">'</span>/foo/:bar<span class="pl-pds">'</span></span>, keys);
<span class="pl-c"><span class="pl-c">//</span>keys = ['bar']</span>
<span class="pl-c"><span class="pl-c">//</span>exp = /^\/foo\/(?:([^\/]+?))\/?$/i</span></pre>
</div> 
<h2> <a id="user-content-live-demo" class="anchor" href="#live-demo" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>Live Demo</h2> 
